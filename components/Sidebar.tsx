...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  const showChatHistory = currentMode === 'chat';
    ...
    <>
      ...
      <aside className={`absolute lg:relative z-30 flex flex-col w-64 bg-gray-100 dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 h-full transition-transform duration-300 ease-in-out ${sidebarClasses}`}>
        {showChatHistory ? (
          ...
          <div className="flex-1 p-4 text-center text-sm text-gray-500 dark:text-gray-400 flex items-center justify-center">
             {t('sidebarFeatureInfo', { feature: currentMode })}
          </div>
        )}
